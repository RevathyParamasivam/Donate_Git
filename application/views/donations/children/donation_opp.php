                        ...
                        <div class="block-content">
                            <div class="row justify-content-center py-20">
                                <div class="col-xl-6">
                                    ...
                                    <?php echo form_open('donation/conform_couple'); ?>
...
<!--                            <form class="js-validation-bootstrap" action="<?php //echo site_url('donation/conform_donation');?>" method="post">-->
                                ...
                                <input type="hidden" class="form-control" id="form_id" name="couple" value="couple">
                                    <!-- For form identification -->
                                
                                  <span style="text-align:left; color:blue; " id="">
                                         Missionary family : Rs 8000. If the Number of Family 2 means 8000*2 = 16000.
                                        </span>
                                 
                                                  
                                <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="val-digits">Number of Family <span class="text-danger">*</span></label>
                                            <div class="col-lg-6">
