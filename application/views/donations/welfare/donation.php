                ...
                <div class="content">
                    ...
                    <div class="content py-5 text-center">
                        <nav class="breadcrumb bg-body-light mb-0">
                            ...
                            <a class="breadcrumb-item" href="<?php echo site_url('donations/Welfare');?>"><?php echo $type;?></a>
                        ...
                        <div class="block-content">
                            <div class="row justify-content-center py-20">
                                <div class="col-xl-8">
                                    ...
                                    <?php echo form_open('donations/Welfare/donation_opp'); ?>
...
<!--                            <form class="js-validation-bootstrap" action="<?php //echo site_url('donation/conform_donation');?>" method="post">-->
                                ...
                                <input type="hidden" class="form-control" id="Welfare" name="Welfare" value="<?php echo $type; ?>">
                                    <!-- For form identification -->
                                ...
                                <!-- <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="val-digits">Number of Motorcycle <span class="text-danger">*</span></label>
                                            <div class="col-lg-6">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="val-number" required="ture" name="val-number" placeholder="">
                                            </div>
                                        </div>        
