...
class Otheres extends CI_Controller 
{
	...
	public function index()
	{
          ...
          $this->load->view('donations/otheres/index');
    ...
    $userCaptcha = $this->input->post('userCaptcha');
	 ...
	 if ($this->form_validation->run() == false)
     {
      ...
      // $this->load->view('index', $data);
          ...
          $this->load->view('don_inc/header');
          $this->load->view('donations/otheres/donation', $data);
          $this->load->view('don_inc/footer');
    }       
    else 
         {
            ...
            // print_r($data);
             ...
             if (!empty($result))
             {
                       ...
                       if ($not_status == '1')
                      {
                         ...
                         redirect('donations/Otheres/index');
                       }
                       else
                       {
                         echo "Email not send";
