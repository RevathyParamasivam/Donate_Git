                ...
                <div class="content">
                    ...
                    <div class="content py-5 text-center">
                        <nav class="breadcrumb bg-body-light mb-0">
                            ...
                            <span class="breadcrumb-item" href="<?php echo site_url('Evangelism');?>">Evangelism Projects</span>
                        ...
                        <div class="block-content">
                            <div class="row justify-content-center py-20">
                                <div class="col-xl-8">
                                    ...
                                    <?php echo form_open('donations/Evangelism/donation'); ?>
...
<!--                            <form class="js-validation-bootstrap" action="<?php //echo site_url('donation/conform_donation');?>" method="post">-->   
                                ...
                                <input type="hidden" class="form-control" id="church" name="church" value="Evangelism">
                                    <!-- For form identification -->
                                    ...
                                    <span style="text-align:left; color:blue; " id="">
                                         Village Gospel Program (VGP) : Rs.5000/program, Film Team Support : Rs.10,000/ team/month, Mini Gospel Outreach :  Rs 15,000 / program.
                                        </span>                            
                                <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <select class="form-control" id="purpose" name="purpose" required="true">
                                                    ...
                                                    <option value="Village Gospel Program">Village Gospel Program (VGP)</option>
                                                    <option value="Film Team Support">Film Team Support</option>
                                                    <option value="Mini Gospel Outreach">Mini Gospel Outreach</option>
