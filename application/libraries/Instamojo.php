...
class Instamojo {	
    ...
    */
    						   ...
    						   )
    {
		...
		$wh_url = $this->_ci->config->item('mojo_webhook_url');
		...
		{			
			...
			"buyer_name" => $buyer_name , "email" => $email ,"webhook"=> $wh_url, "send_email" => $send_email , 
    ...
    */
    ...
    public function insertData($data)
    {
		...
		$insert_id = $this->_ci->db->insert_id();
		  // $payt_id = md5($insert_id);
		
		  $this->_ci->session->set_userdata('pay_id',$insert_id);
    }
