                ...
                <div class="content">
                    ...
                    <div class="content py-5 text-center">
                        <nav class="breadcrumb bg-body-light mb-0">
                            ...
                            <a class="breadcrumb-item" href="<?php echo site_url('categories/children');?>"><?php echo $type;?></a>
                        ...
                        <div class="block-content">
                            <div class="row justify-content-center py-20">
                                <div class="col-xl-8">
                                    ...
                                    <?php echo form_open('donations/Children/donation_opp'); ?>
...
<!--                            <form class="js-validation-bootstrap" action="<?php //echo site_url('donation/conform_donation');?>" method="post">-->
                                ...
                                <input type="hidden" class="form-control" id="children" name="children" value="<?php echo $type; ?>">
                                    <!-- For form identification -->
                                  ...
                                  <span style="text-align:left; color:blue; " id=""><?php echo $message; ?></span>
                                 
                                                  
                                <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="val-digits">Number of Child <span class="text-danger">*</span></label>
                                            <div class="col-lg-6">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="val-number" required="ture" name="val-number" placeholder="1200">
                                            </div>
                                        </div>        
                                    ...
                                    <hr>
                                        ...
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="miss_pre">Form <span class="text-danger">*</span></label>
                                            
                                            <div class="col-lg-6">
                                                <input type="text" class="js-datepicker form-control" id="example-datepicker2" 
                                                name="cfrom" data-week-start="1" data-autoclose="true" data-today-highlight="true" data-date-format="dd/mm/yy" required="true" placeholder="dd/mm/yy">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="miss_pre">To <span class="text-danger">*</span></label>
                                            
                                            <div class="col-lg-6">
                                                <input type="text" class="js-datepicker form-control" id="example-datepicker2" 
                                                name="cto" data-week-start="1" data-autoclose="true" data-today-highlight="true" data-date-format="dd/mm/yy" required="true" placeholder="dd/mm/yy">
                                            </div>
                                        </div>
            ...
            <input type="text" class="form-control" id="val-username" required="true" name="name" placeholder="Sponsor/Sponsoring Group Name">
                                ...
                                <label class="col-lg-4 col-form-label" for="val-phoneus">Phone <span class="text-danger">*</span></label>
                                        ...
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="miss_pre">Birth Day</label>
                                            
                                            <div class="col-lg-6">
                                                <input type="text" class="js-datepicker form-control" id="example-datepicker2" 
                                                name="bday" data-week-start="1" data-autoclose="true" data-today-highlight="true" data-date-format="dd/mm/yy" placeholder="dd/mm/yy">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="miss_pre">Wedding Day</span></label>
                                            
                                            <div class="col-lg-6">
                                                <input type="text" class="js-datepicker form-control" id="example-datepicker2" 
                                                name="wday" data-week-start="1" data-autoclose="true" data-today-highlight="true" data-date-format="dd/mm/yy" placeholder="dd/mm/yy">
                                            </div>
                                        </div>
                                            
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="example-textarea-input1">Special Occasion</label>
                                            <div class="col-lg-8">
                                                <textarea class="form-control" id="example-textarea-input1" name="special_occ" rows="1"  placeholder="Special Occasion "></textarea>
                                            </div>
                                        </div>
                    ...
                    <div class="content py-5 text-center">
                        <nav class="breadcrumb bg-body-light mb-0">
                            <a class="breadcrumb-item" href="<?php echo site_url('categories/donation');?>">Donation</a>
                            <a class="breadcrumb-item" href="<?php echo site_url('categories/vbb');?>"></a>
                            <span class="breadcrumb-item active">Donation Page</span>
                        </nav>
                    </div>
                </div>
