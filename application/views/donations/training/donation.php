                ...
                <div class="content">
                    ...
                    <div class="content py-5 text-center">
                        <nav class="breadcrumb bg-body-light mb-0">
                            ...
                            <a class="breadcrumb-item" href="<?php echo site_url('donations/Training');?>">Training Support</a>
...
<!--                            <form class="js-validation-bootstrap" action="<?php //echo site_url('donation/conform_donation');?>" method="post">-->   
                                ...
                                <input type="hidden" class="form-control" id="church" name="Training" value="Training">
                                    ...
                                    <span style="text-align:left; color:blue; " id="">
                                         Bible College Student Support : Rs. 2,000/ month/student, Discipleship Training Support : Rs. 1,500/ month/student, Leadership Training Support : Rs. 2,500/ month/student.
                                        </span>                            
                                <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <option value="Bible College Student">Bible College Student</option>
                                                    <option value="Discipleship Training">Discipleship Training </option>
            ...
            <input type="text" class="form-control" id="val-username" required="true" name="name" placeholder="Sponsor/Sponsoring Group Name">
                    ...
                    <div class="content py-5 text-center">
                        <nav class="breadcrumb bg-body-light mb-0">
                            <a class="breadcrumb-item" href="<?php echo site_url('categories/donation');?>">Donation</a>
                            <a class="breadcrumb-item" href="<?php echo site_url('Training');?>">Training Support</a>
                            <span class="breadcrumb-item active">Donation Page</span>
                        </nav>
                    </div>
                </div>
