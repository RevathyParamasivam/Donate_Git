                           ...
                           <center>
                            ...
                            <a class="block block-rounded text-center" ></a>
                                <div class="block-header">
                                    <h3 style="color: green;" class="block-title"> Donation Sucessfull</h3>
                                </div>
                                ...
                                <div class="block-content">
                                    ...
                                    <table class="table table-border mb-0">
                                        ...
                                        <tbody> 
                                           ...
                                           <!--  <tr class="bg-body-light">
                                                <td class="">Donation Table ID</td>
                                                <td ><?php //echo $donation_t_id?></td>
                                            </tr>
                                            <tr class="bg-body-light">
                                                <td class="">Payment Table id</td>
                                                <td ><?php //echo $payment_t_id;?></td>
                                            </tr> -->
                                ...
                                <div class="block-content block-content-full bg-gray-lighter">
                                    <span class="btn btn-hero btn-sm btn-rounded btn-noborder btn-primary"><?php echo $status;?></span>
                                </div>
