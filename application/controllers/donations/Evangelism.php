...
class Evangelism extends CI_Controller 
{
	...
	public function index()
	{
          ...
          $this->load->view('donations/evangelism/index');
	...
	public function donor_details()
	{
			$this->load->library('form_validation');
		      $this->load->view('don_inc/header');
          $this->load->view('donations/evangelism/donation');
          $this->load->view('don_inc/footer');
	...
	public function donation()
	{
              ...
              $miss_support = $this->input->post('church',TRUE);
           ...
           if (isset($miss_support))
           {
                   ...
                   {
                            $this->load->view('don_inc/header');
				          $this->load->view('donations/evangelism/donor_details');
				          $this->load->view('don_inc/footer');
                   ...
                   else
                   {
                        // echo "you are here";
                           ...
                           $purpose = $this->input->post('purpose',TRUE);
                            ...
                            // echo "$purpose";
                      if ($purpose === "Village Gospel Program" || $purpose === "Film Team Support" || $purpose === "Mini Gospel Outreach" )
                       {
