            ...
            <nav class="hk-breadcrumb" aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-light bg-transparent">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">All Donation</li>
                </ol>
            </nav>
                <!-- Page Content -->
                <div class="content">
                                        ...
                                        <div class="col-6 text-right border-r">
                                            <div class="invisible" data-toggle="appear" data-class="animated fadeInLeft">
                                                <div class="font-size-h3 font-w600 text-info"><?php
                                                 foreach ($sum as $amount) 
                                                 {
                                                     echo $amount->amount;
                                                 }

                                                  ?></div>
                                                <div class="font-size-sm font-w600 text-uppercase text-muted">Donation Total Amount</div>
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="invisible" data-toggle="appear" data-class="animated fadeInRight">
                    ...
                    <div class="block">
                        <div class="block-header block-header-default">
                            <h3 class="block-title">Donation details <small></small></h3>
                        </div>
                        <div class="block-content block-content-full">
                            <table class="table table-bordered table-striped table-vcenter js-dataTable-full-pagination">
                                <thead>
                                    ...
                                    <tbody>
                                    <?php $i=1; foreach ($donation as $row) { ?>
                                    <tr>
                                        <td><?php echo $i;  ?></td>
