                ...
                <div class="content">
                    ...
                    <div class="content py-5 text-center">
                        <nav class="breadcrumb bg-body-light mb-0">
                            ...
                            <span class="breadcrumb-item" href="<?php echo site_url('Church');?>">Church Establishment Fund</span>
                        ...
                        <div class="block-content">
                            <div class="row justify-content-center py-20">
                                <div class="col-xl-8">
                                    ...
                                    <?php echo form_open('donations/Church/donation'); ?>
...
<!--                            <form class="js-validation-bootstrap" action="<?php //echo site_url('donation/conform_donation');?>" method="post">-->   
                                ...
                                <input type="hidden" class="form-control" id="church" name="church" value="church">
                                    <!-- For form identification -->
                                    ...
                                    <span style="text-align:left; color:blue; " id="">
                                         Church Building : Rs. 8,00,000/-, Church Land : Rs. 7,00,000/-, Parsonage : Rs. 5,00,000/-
                                        </span>                            
